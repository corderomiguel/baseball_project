...
```{r boxplots, echo=FALSE, fig.cap="Histograma y gráfico de cajas para las variables", fig.height=5, fig.pos="h!"}
par(mfrow=c(3,2))
...
```{r boxplots2, echo=FALSE, fig.cap="Histograma y gráfico de cajas para las variables (continuación)", fig.height=5, fig.pos="h!"}
par(mfrow=c(3,2))
